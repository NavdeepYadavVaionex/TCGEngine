...
MatchTool.GainMatchReward = async(player, opponent, player_elo, opponent_elo, winner_email) => {

    var won = winner_email == player.email;
    var lost = winner_email == opponent.email;
