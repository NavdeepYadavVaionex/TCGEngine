...
exports.route = function (app) {
  ...
  app.post("/users/edit/:email", app.post_limiter, [
    AuthTool.isValidJWT,
    AuthTool.isPermissionLevel(USER),
  ...
  //Body: permission
  app.post("/users/permission/edit/:email", app.post_limiter, [
    AuthTool.isValidJWT,
  ...
  //Email confirm
  app.get("/users/email/confirm/:email/:code", [
  ...
  app.post("/users/cards/add/:email", app.post_limiter, [
    AuthTool.isValidJWT,
    AuthTool.isPermissionLevel(SERVER),
    UsersCardsController.AddCards,
  ]);

  app.post("/users/packs/add/:email", app.post_limiter, [
    AuthTool.isValidJWT,
    AuthTool.isPermissionLevel(SERVER),
  ...
  app.post("/users/rewards/gain/:email", app.post_limiter, [
    AuthTool.isValidJWT,
    AuthTool.isPermissionLevel(USER),
